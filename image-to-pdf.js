class ImageToPdfConverter {
    ...
    bindEvents() {
        ...
        this.uploadZone.addEventListener('click', (e) => {
            // Only trigger file input if clicking on the upload zone itself, not on child elements
        ...
        if (uploadBtn) {
            uploadBtn.addEventListener('click', (e) => {
                e.stopPropagation(); // Prevent the upload zone click event
                this.imageUpload.click();
            });
        }
        ...
        this.uploadZone.addEventListener('dragleave', (e) => {
            // Only remove drag-over class if leaving the upload zone entirely
